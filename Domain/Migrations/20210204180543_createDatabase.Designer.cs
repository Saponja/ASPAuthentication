...
namespace Domain.Migrations
{
    ...
    [Migration("20210204180543_createDatabase")]
            ...
            modelBuilder.Entity("Airport.Domain.Reservation", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            SeatId = 2,
                            PassangerId = 1,
                            DateOfReservation = new DateTime(2021, 2, 4, 19, 5, 42, 683, DateTimeKind.Local).AddTicks(1974)
                        },
                        new
                        {
                            SeatId = 14,
                            PassangerId = 1,
                            DateOfReservation = new DateTime(2021, 2, 4, 19, 5, 42, 688, DateTimeKind.Local).AddTicks(8980)
                        },
                        new
                        {
                            SeatId = 4,
                            PassangerId = 2,
                            DateOfReservation = new DateTime(2021, 2, 4, 19, 5, 42, 688, DateTimeKind.Local).AddTicks(9073)
                        },
                        new
                        {
                            SeatId = 11,
                            PassangerId = 3,
                            DateOfReservation = new DateTime(2021, 2, 4, 19, 5, 42, 688, DateTimeKind.Local).AddTicks(9083)
                        },
                        new
                        {
                            SeatId = 6,
                            PassangerId = 4,
                            DateOfReservation = new DateTime(2021, 2, 4, 19, 5, 42, 688, DateTimeKind.Local).AddTicks(9089)
                        });
                });

...
namespace Domain.Migrations
{
    ...
    [Migration("20210301172143_UserRoleAdded")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Airport.Domain.Reservation", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            SeatId = 2,
                            PassangerId = 1,
                            DateOfReservation = new DateTime(2021, 3, 1, 18, 21, 42, 518, DateTimeKind.Local).AddTicks(8535)
                        },
                        new
                        {
                            SeatId = 14,
                            PassangerId = 1,
                            DateOfReservation = new DateTime(2021, 3, 1, 18, 21, 42, 528, DateTimeKind.Local).AddTicks(9157)
                        },
                        new
                        {
                            SeatId = 4,
                            PassangerId = 2,
                            DateOfReservation = new DateTime(2021, 3, 1, 18, 21, 42, 528, DateTimeKind.Local).AddTicks(9250)
                        },
                        new
                        {
                            SeatId = 11,
                            PassangerId = 3,
                            DateOfReservation = new DateTime(2021, 3, 1, 18, 21, 42, 528, DateTimeKind.Local).AddTicks(9260)
                        },
                        new
                        {
                            SeatId = 6,
                            PassangerId = 4,
                            DateOfReservation = new DateTime(2021, 3, 1, 18, 21, 42, 528, DateTimeKind.Local).AddTicks(9266)
                        });
                });
            ...
            modelBuilder.Entity("Airport.Domain.User", b =>
                {
